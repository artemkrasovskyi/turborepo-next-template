...
export function SignInForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <label htmlFor="sign-in-email" className="flex flex-col gap-1 text-sm font-medium text-slate-700">
        Email
        <input
          id="sign-in-email"
          type="email"
      ...
      <label htmlFor="sign-in-password" className="flex flex-col gap-1 text-sm font-medium text-slate-700">
        Password
        <input
          id="sign-in-password"
          type="password"
      ...
      <p className="text-sm text-slate-600">
        Need an account?{' '}
        <Link href="/sign-up" className="font-semibold text-teal-700 hover:underline">
          Sign up
        </Link>
      </p>
    </form>
